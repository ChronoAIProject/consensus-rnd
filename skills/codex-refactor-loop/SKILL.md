...
- [scripts/consensus-rnd-cli runtime-retention](scripts/consensus-rnd-cli runtime-retention) — canonical RuntimeRetention helper for host-opt-in skill-private generated file cleanup, pending-events compaction, and planner-proven stale worktree remove/prune; `log-retention` is a one-release compatibility alias.
