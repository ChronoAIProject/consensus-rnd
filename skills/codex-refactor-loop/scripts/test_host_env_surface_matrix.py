...
class HostEnvSurfaceMatrixTests(unittest.TestCase):
    ...
    def test_defaults_and_missing_behaviors_match(self) -> None:
        cases = {
            ...
            "ACTIVE_CONTROLLER_OWNER": ("", "single-device local-owner noop"),
        ...
        self.assertEqual("optional-noop", self.rows["ACTIVE_CONTROLLER_OWNER"]["Category"])
    ...
    def test_high_risk_runtime_literals_remain_aligned(self) -> None:
        ...
        self.assertIn('env.get("ACTIVE_CONTROLLER_OWNER", "")', active_controller)
