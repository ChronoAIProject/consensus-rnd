...
def valid_proof() -> dict[str, object]:
    ...
    return {
        ...
        "scope_paths": ["skills/codex-refactor-loop/scripts/codex_refactor_loop/consensus_gate.py"],
    }
...
class ConsensusGateProofTests(unittest.TestCase):
    def test_valid_proof_returns_typed_contract_without_authority_fields(self) -> None:
        ...
        self.assertEqual(("skills/codex-refactor-loop/scripts/codex_refactor_loop/consensus_gate.py",), proof.scope_paths)
