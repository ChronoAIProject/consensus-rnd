...
- fact_source: release candidate/decision artifacts + mapped manifests + exact fresh SHA + Checks API projection, with coordinate policy validated by #322 preflight when applicable.
