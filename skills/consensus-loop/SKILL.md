...
完整下游装机顺序见 [Downstream install walkthrough](#downstream-install-walkthrough);本段保留 scheduler-backed helper invariant and the mandatory cron/launchd outer repair surface.
