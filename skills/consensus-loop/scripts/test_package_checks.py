...
DEGRADATION_MODULE = REPO_ROOT / "skills/consensus-loop/scripts/codex_refactor_loop/checks/degradation.py"
HOST_FIXTURE_SMOKE_MODULE = REPO_ROOT / "skills/consensus-loop/scripts/codex_refactor_loop/checks/host_fixture_smoke.py"
MANIFEST_MODULE = REPO_ROOT / "skills/consensus-loop/scripts/codex_refactor_loop/checks/manifest.py"
