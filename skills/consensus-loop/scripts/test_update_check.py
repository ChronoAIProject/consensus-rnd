...
class UpdateCheckTests(unittest.TestCase):
    ...
    def test_release_failure_falls_back_to_tags(self) -> None:
        ...
        def runner(cmd: list[str]) -> subprocess.CompletedProcess[str]:
            ...
            if cmd[-1].endswith("/releases/latest"):
        ...
        # gh api takes exactly one endpoint arg (regression guard for #883)
        self.assertEqual(["gh", "api", "repos/ChronoAIProject/consensus-rnd/releases/latest"], calls[0])
        self.assertEqual(["gh", "api", "repos/ChronoAIProject/consensus-rnd/tags"], calls[1])
